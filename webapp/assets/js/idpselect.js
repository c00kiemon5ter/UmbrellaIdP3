...
function IdPSelectLanguages(){
    ...
    'ja': {
        'fatal.divMissing': '"insertAtDiv" ã® ID ã‚’æŒã¤ <div> ãŒ HTML ä¸­ã«å­˜åœ¨ã—ã¾ã›ã‚“',
        'fatal.noXMLHttpRequest': 'ãƒ–ãƒ©ã‚¦ã‚¶ãŒ XMLHttpRequest ã‚’ã‚µãƒãƒ¼ãƒˆã—ã¦ã„ãªã„ã®ã§ IdP æƒ…å ±ã‚’å–å¾—ã§ãã¾ã›ã‚“',
        'fatal.wrongProtocol' : 'DSã¸æ¸¡ã•ã‚ŒãŸ Policy ãƒ‘ãƒ©ãƒ¡ãƒ¼ã‚¿ãŒ "urn:oasis:names:tc:SAML:profiles:SSO:idpdiscovery-protocol:single" ã§ã¯ã‚ã‚Šã¾ã›ã‚“',
        'fatal.wrongEntityId' : 'SP ã‹ã‚‰æ¸¡ã•ã‚ŒãŸ entityId ãŒè¨­å®šå€¤ã¨ç•°ãªã‚Šã¾ã™',
        'fatal.noData' : 'ãƒ¡ã‚¿ãƒ‡ãƒ¼ã‚¿ãŒç©ºã§ã™',
        'fatal.loadFailed': 'æ¬¡ã® URL ã‹ã‚‰ãƒ¡ã‚¿ãƒ‡ãƒ¼ã‚¿ã‚’ãƒ€ã‚¦ãƒ³ãƒ­ãƒ¼ãƒ‰ã§ãã¾ã›ã‚“ã§ã—ãŸ: ',
        'fatal.noparms' : 'DSã«ãƒ‘ãƒ©ãƒ¡ãƒ¼ã‚¿ãŒæ¸¡ã•ã‚Œã¦ãŠã‚‰ãš defaultReturn ã‚‚è¨­å®šã•ã‚Œã¦ã„ã¾ã›ã‚“',
        'fatal.noReturnURL' : "æˆ»ã‚Š URL ãŒæŒ‡å®šã•ã‚Œã¦ã„ã¾ã›ã‚“",
        'fatal.badProtocol' : "æˆ»ã‚Š URL ã¯ https:// ã‹ http:// ã§å§‹ã¾ã‚‰ãªã‘ã‚Œã°ãªã‚Šã¾ã›ã‚“",
        'idpPreferred.label': 'é¸æŠžå€™è£œã® IdP:',
        'idpEntry.label': 'ã‚‚ã—ãã¯ã‚ãªãŸã®æ‰€å±žæ©Ÿé–¢åã‚’å…¥åŠ›ã—ã¦ãã ã•ã„',
        'idpEntry.NoPreferred.label': 'ã‚ãªãŸã®æ‰€å±žæ©Ÿé–¢åã‚’å…¥åŠ›ã—ã¦ãã ã•ã„',
        'idpList.label': 'ã‚‚ã—ãã¯ã‚ãªãŸã®æ‰€å±žæ©Ÿé–¢ã‚’é¸æŠžã—ã¦ãã ã•ã„',
        'idpList.NoPreferred.label': 'ã‚ãªãŸã®æ‰€å±žæ©Ÿé–¢ã‚’ä¸€è¦§ã‹ã‚‰é¸æŠžã—ã¦ãã ã•ã„',
        'idpList.defaultOptionLabel': 'æ‰€å±žæ©Ÿé–¢ã‚’é¸æŠžã—ã¦ãã ã•ã„...',
        'idpList.showList' : 'ä¸€è¦§ã‹ã‚‰é¸æŠžã™ã‚‹',
        'idpList.showSearch' : 'æ©Ÿé–¢åã‚’å…¥åŠ›ã™ã‚‹',
        'submitButton.label': 'é¸æŠž',
        'autoFollow.message' : 'æ¬¡ã®æœŸé–“é¸æŠžã—ãŸæ©Ÿé–¢ã«è‡ªå‹•çš„ã«é·ç§»ã™ã‚‹:',
        'autoFollow.never' : 'è‡ªå‹•é·ç§»ã—ãªã„',
        'autoFollow.time0' : '1æ—¥',
        'autoFollow.time1' : '3ã‹æœˆ',
        'autoFollow.time2' : '9ã‹æœˆ',
        'helpText': 'Help',
        'defaultLogoAlt' : 'DefaultLogo'
    },
    'pt-br': {
        'fatal.divMissing': 'A tag <div> com "insertAtDiv" nÃ£o foi encontrada no arquivo HTML',
        'fatal.noXMLHttpRequest': 'Seu navegador nÃ£o suporta "XMLHttpRequest", impossÃ­vel de carregador os dados do IdP selecionado',
        'fatal.wrongProtocol' : 'A polÃ­tica "Policy" fornecida para o DS nÃ£o foi "urn:oasis:names:tc:SAML:profiles:SSO:idpdiscovery-protocol:single"',
        'fatal.wrongEntityId' : 'entityId oferecido pelo SP nÃ£o confere com o da configuraÃ§Ã£o',
        'fatal.noData' : 'O arquivo de metadados nÃ£o retornou nada;',
        'fatal.loadFailed': 'Falhou ao realizar download do metadado de ',
        'fatal.noparms' : 'Sem parÃ¢metros para sessÃ£o de descoberta e sem parÃ¢metro "defaultReturn" configurado',
        'fatal.noReturnURL' : "NÃ£o foi definida um endereÃ§o (URL) de retorno no parÃ¢metro",
        'fatal.badProtocol' : "Retorno do endereÃ§o requisitado deve comeÃ§ar com https:// ou http://",
        'idpPreferred.label': 'Use estas InstituiÃ§Ãµes sugeridas: ',
        'idpEntry.label': 'Ou informe o nome da sua InstituiÃ§Ã£o',
        'idpEntry.NoPreferred.label': 'Informe o nome da sua InstituiÃ§Ã£o',
        'idpList.label': 'Ou selecione sua InstituiÃ§Ã£o atravÃ©s da lista abaixo',
        'idpList.NoPreferred.label': 'Selecione sua InstituiÃ§Ã£o atravÃ©s da lista abaixo',
        'idpList.defaultOptionLabel': 'Por favor, selecione sua InstituiÃ§Ã£o: ',
        'idpList.showList' : 'Permitir que eu escolha um IdP atravÃ©s de uma lista',
        'idpList.showSearch' : 'Permitir que eu especifique o IdP',
        'submitButton.label': 'Continuar ',
        'helpText': 'Ajuda',
        'defaultLogoAlt' : 'Logo padrÃ£o'
        }
    };
}
...
TypeAheadControl.prototype.draw = function(setFocus) {
    ...
    document.getElementById("idpSelectFormAuto").appendChild(this.dropDown);
...
TypeAheadControl.prototype.populateDropDown = function(list) {
	...
	li.setAttribute('class', 'idpselectoptionclass');
...
TypeAheadControl.prototype.select = function(selected) {
	...
	node.setAttribute('class', 'idpselectoptionclass');
        if (node == selected) {
            //
            // Highlight it
            //
...
function IdPSelectUI() {
    ...
    */
	...
	form.setAttribute('id', 'idpSelectFormAuto');
        var i = 0;
