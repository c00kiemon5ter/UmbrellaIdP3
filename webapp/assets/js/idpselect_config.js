...
function IdPSelectUIParms(){
    ...
    this.defaultReturn = 'https://umbrellaid.org/Shibboleth.sso/Login?SAMLDS=1&target=https://umbrellaid.org/euu';       // If non null, then the default place to send users who are not
    ...
    this.maxResults = 9;            // How many results to show at once or the number at which to
                                     // start showing if alwaysShow is false
    this.myEntityID = 'https://umbrellaid.org/shibboleth';          // If non null then this string must match the string provided in the DS parms
//    this.myEntityID = 'undefined';
//    this.myEntityID = null;
    this.preferredIdP = null;        // Array of entityIds to always show
    this.hiddenIdPs = new Array("https://umbrellaid.org/idp/shibboleth");          // Array of entityIds to delete
