...
function IdPSelectUIParms(){
    ...
    this.defaultReturn = "https://umbrella.psi.ch/Shibboleth.sso/Login?SAMLDS=1&target=https://umbrella.psi.ch";
    ...
    this.myEntityID = 'https://umbrella.psi.ch/';          // If non null then this string must match the string provided in the DS parms
